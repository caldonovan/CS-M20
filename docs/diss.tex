...
consists of few elements to ensure the problem is presented cleanly, the first being comments.
Comments can be marked using the letter \texttt{'c'}.
...
SAT solver about the problem it is about to ingest, denoted using the letter
\texttt{'p'}.
