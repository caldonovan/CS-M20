...
Another solution that we can use for our testing strategy is quite simple. Utilising a well-known solver that has been proven to 
be accurate, we could give it a range of problems in alternating difficulty and compare the results to that of our solver. 
Although this is rudimentary, it can be applied quite well in our instance and can quickly discover potential discrepancies in 
our program.
