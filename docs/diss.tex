...
%\end{itemize}
This section details the bulk of what our program will do. Based off of Algorithm L discussed in the design section, we will be
...
%\end{itemize}
% TODO: Attempt to add results from other solvers here.
...
development and incorporates some of the most advanced features for a FOSS solver. Compared to
\textit{Minisat}, this solver is significantly more complex. It should give us safe results that we
can use to ensure no discrepancies between our solver and \textit{Minisat}.
...
% TODO: Add the results for the 'easy' set here.
...
% TODO: Add the results for the 'medium' set here.
...
% TODO: Add the results for the 'hard' set here.
