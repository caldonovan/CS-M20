...
Let us begin with the first step of the algorithm; filling all necessary variables with the appropriate data.

\begin{enumerate}
    \item Fill the appropriate variables with the problem data.
    \item Pre-process the given formula and elimitate unit clauses. Terminate if no clauses remain.
    \item Something to do with lookahead here?
    \item Let us continue.
\end{enumerate}
